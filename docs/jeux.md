...
5. Le message WeChat. Un message reçu, trois réponses dont une tient. 你好吗？→ 我很好，你呢？ Arbre de 3 à 10 échanges par famille.
   Réalisé (4b.7) : 53 dialogues de 2 à 4 échanges dans `data/sources/wechat/` (`wechat.json`), chacun rattaché à une famille par son caractère clé ; trois ou quatre répliques, les mauvaises `hors-sujet` ou `contresens`. Une mauvaise réplique ne note rien ; une bonne du premier coup note ses caractères. Ouvert depuis Jouer, pas encore depuis le pas Utiliser.
...
7. Les lettres de Que. Une lettre par semaine, 40 à 120 caractères, uniquement acquis, question finale à un mot. Feuilleton : Que voyage de 西安 à 喀什.
   Réalisé (4b.8), à relire : douze lettres dans `data/sources/lettres-versions/`, la lettre n écrite avec les seuls caractères que le parcours Lire pose au jour 7n (14 au jour 7, 109 au jour 84). 西安 et 喀什 ne s'écrivent pas avec cet acquis (安, 喀, 什) : Que part de la porte de M. Wang vers la montagne, puis seul vers les Monts de l'Ouest 西山, et revient en volant (飞 arrive au jour 84). Une lettre arrive le dimanche, ou à la première session de la semaine si l'on n'en a pas fait le dimanche, quand tous ses caractères ont une carte ; une par semaine, sans rattrapage. Elle se lit dans Lire, comme un conte, et la case Lire du menu l'annonce la semaine de son arrivée. Parcours HSK : pas de lettres propres ; 只 n'y étant jamais posé, dix lettres sur douze ne s'y ouvrent pas.
